...
public class KhachHangDAO implements DAOInterface<KhachHang> {
	...
	public int insert(KhachHang t) {
		...
		try {
			...
			st.setBoolean(12, t.isDangKyNhanTin());
	...
	public int update(KhachHang t) {
		...
		try {
			...
			st.setBoolean(11, t.isDangKyNhanTin());
	...
	public KhachHang kiemTraDangNhap(String t,String p) {
		KhachHang ketQua = null;
		try {
			// Bước 1: tạo kết nối đến CSDL
			Connection con = JDBCUtil.getConnection();
			...
			while (rs.next()) {
				...
				ketQua = new KhachHang(maKhacHang, tenDangNhap, matKhau, gioiTinh, hoVaTen, diaChi, diaChiNhanHang,
						diaChiMuaHang, ngaySinh, soDienThoai, email, dangKyNhanBangTin);
			}
	...
	public int updateMatKhau(KhachHang t) {
		int ketQua = 0;
		try {
			// Bước 1: tạo kết nối đến CSDL
			Connection con = JDBCUtil.getConnection();
