...
public class SanPhamDAO implements DAOInterface<SanPham> {
	...
	public ArrayList<SanPham> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				SanPham sp = new SanPham(masanpham, tensanpham, tacGia, namxuatban, gianhap, giagoc, giaban, soluong, theLoai, ngonngu, mota,img);
				ketQua.add(sp);
			}
	...
	public ArrayList<SanPham> selectByCategory(String t) {
		ArrayList<SanPham> ketQua = new ArrayList<SanPham>();
		try {
			// Bước 1: tạo kết nối đến CSDL
			Connection con = JDBCUtil.getConnection();
